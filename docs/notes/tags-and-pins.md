...
- **Only the *filter* narrows.** `listProps.tagGroups` in `places-manager.tsx` stays the
  ...
  Locations → Tags & fields, and still deletable there. Nothing sweeps it, deliberately: sweeping
